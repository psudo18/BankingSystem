...
################################################################################
## Form generated from reading UI file 'transactionc.ui'
##
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText("")
        self.pushButton_2.setText(QCoreApplication.translate("Dialog", u"Confirm", None))
        self.label_2.setText(QCoreApplication.translate("Dialog", u"Name : ajay", None))
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("Dialog", u"Amount", None))
    # retranslateUi
