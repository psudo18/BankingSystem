...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText("")
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("Dialog", u"Amount to deposit", None))
