...
"}")
        ...
        self.pushButton.setGeometry(QRect(100, 230, 161, 41))
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton.setText(QCoreApplication.translate("Dialog", u"Withdraw", None))
        self.label.setText("")
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("Dialog", u"Amount to withdraw", None))
